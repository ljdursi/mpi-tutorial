...
contains
    ...
    minp = minval(pres)
    maxp = maxval(pres)
    call MPI_Allreduce(mind, globmind, 1, MPI_REAL, MPI_MIN, MPI_COMM_WORLD, ierr)
    call MPI_Allreduce(maxd, globmaxd, 1, MPI_REAL, MPI_MAX, MPI_COMM_WORLD, ierr)
    call MPI_Allreduce(minp, globminp, 1, MPI_REAL, MPI_MIN, MPI_COMM_WORLD, ierr)
    call MPI_Allreduce(maxp, globmaxp, 1, MPI_REAL, MPI_MAX, MPI_COMM_WORLD, ierr)
